...
public class Query01ReflectionTest extends Query01Test {
    ...
    // Looger del test
    private static final Logger LOGGER = LoggerFactory.getLogger(Query01ReflectionTest.class);

    /**
     * Constructor por defecto.
     */
    public Query01ReflectionTest() {
        // Seteamos el nombre del test
        setName(ConfigurationManager.get("apache.benchmark.config.sql.query.01.reflection.name"));
    }
    ...
    public Boolean prepare() {
        ...
        // esquema concreto.
        JavaRDD<Ranking> rowRDD = rankingData.map(
